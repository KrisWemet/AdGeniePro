...
def test_clickbank_redirects_to_the_offer_with_a_tid(api_client, created_offer):
...
def test_postback_attributes_revenue_to_the_creative(api_client, created_offer, settings):
    ...
    click_id = redirect.headers["location"].split("tid=")[1].split("&")[0]
